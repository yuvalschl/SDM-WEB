...
public class ItemDTO {
    ...
    public ItemDTO(String name, int id, float amount, String sellBy, String isPartOfSale, float pricePerUnit) {
        final DecimalFormat decimalFormat = new DecimalFormat("0.00");
        this.name = name;
        this.id = id;
        this.amount = Float.parseFloat(decimalFormat.format(amount));
        this.sellBy = sellBy;
        this.totalItemCost = Float.parseFloat(decimalFormat.format(pricePerUnit * amount));
